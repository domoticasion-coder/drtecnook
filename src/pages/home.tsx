    ...
    <div className="space-y-16 pb-16 tech-bg">
          ...
          >
            ...
            <div className="absolute inset-0 z-20 flex items-center">
              <div className="container mx-auto px-4 max-w-4xl space-y-6">
                <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-serif uppercase tracking-widest ${slide.badgeColorClass}`}>
      ...
      <section className="container mx-auto px-4 space-y-8">
        ...
        <div className="grid gap-6 grid-cols-2 lg:grid-cols-4">
          {[
            { name: "Herramientas de Precisión", value: "Herramientas", icon: Wrench, count: "Estaciones, Lupas & Soldadores", bg: "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=400&auto=format&fit=crop&q=60", textClass: "group-hover:text-logo-pink", iconClass: "text-logo-pink", bgClass: "bg-logo-pink/10 border-logo-pink/25", borderClass: "border-border/40 hover:border-logo-pink/60" },
            { name: "Insumos & Repuestos", value: "Insumos", icon: Package, count: "Módulos, Baterías & Pegamentos", bg: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&auto=format&fit=crop&q=60", textClass: "group-hover:text-logo-yellow", iconClass: "text-logo-yellow", bgClass: "bg-logo-yellow/10 border-logo-yellow/25", borderClass: "border-border/40 hover:border-logo-yellow/60" },
            { name: "Capacitaciones", value: "Capacitaciones", icon: GraduationCap, count: "Cursos Inicial, Intermedio y Avanzado", bg: "https://images.unsplash.com/photo-1597733336794-12d05021d510?w=400&auto=format&fit=crop&q=60", textClass: "group-hover:text-logo-green", iconClass: "text-logo-green", bgClass: "bg-logo-green/10 border-logo-green/25", borderClass: "border-border/40 hover:border-logo-green/60" },
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 z-20 p-4 flex flex-col justify-between">
                  <div className={`p-2 border rounded-lg w-fit ${col.bgClass}`}>
                    <IconComponent className={`w-5 h-5 animate-pulse-subtle ${col.iconClass}`} />
                  </div>
                  <div>
                    <h4 className={`font-serif font-bold text-sm text-foreground transition-colors ${col.textClass}`}>
                      {col.name}
                    </h4>
